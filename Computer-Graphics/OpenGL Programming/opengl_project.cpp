...
void ground()
{
    ...
    glVertex2f(0.2f, -0.03);
    glVertex2f(0.3f, -0.03);
    glVertex2f(0.4f, -0.03);
    glVertex2f(0.5f, -0.03);
    glVertex2f(0.6f, -0.03);
    glVertex2f(0.7f, -0.03);
    glVertex2f(0.8f, -0.03);
    glVertex2f(0.9f, -0.03);
...
void man()
{
    ...
    GLfloat x = 0.2f; GLfloat y = -0.3f; GLfloat radius = -.05f;
    int triangleAmount = 20;
    GLfloat twicePi = 2.0f * PI;
...
void handleKeypress(unsigned char key, int x, int y) {
    ...
    case  'd':
        ...
        glutCreateWindow("Team Paper Fly");
